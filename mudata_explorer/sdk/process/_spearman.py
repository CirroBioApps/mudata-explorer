...
def spearman(
    ...
    table_comparitor_comparitor_table_sidebar=False,
    table_comparitor_comparitor_cname=None,
    table_comparitor_comparitor_cname_sidebar=False,
    table_comparitor_comparitor_label='Comparitor',
    table_comparitor_comparitor_label_sidebar=False,
    table_comparitor_rows_query_query_type='',
    table_comparitor_rows_query_query_sidebar=False,
    ...
    table_comparitor_cols_query_query_sidebar=False,
...
- Scipy: [scipy.stats.spearmanr](https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.spearmanr.html)
    ...
    process = make_process(
        ...
        params={
            ...
            'table.comparitor.comparitor.table.sidebar': extra_params.get('table_comparitor_comparitor_table_sidebar', table_comparitor_comparitor_table_sidebar),
            'table.comparitor.comparitor.cname': extra_params.get('table_comparitor_comparitor_cname', table_comparitor_comparitor_cname),
            'table.comparitor.comparitor.cname.sidebar': extra_params.get('table_comparitor_comparitor_cname_sidebar', table_comparitor_comparitor_cname_sidebar),
            'table.comparitor.comparitor.label': extra_params.get('table_comparitor_comparitor_label', table_comparitor_comparitor_label),
            'table.comparitor.comparitor.label.sidebar': extra_params.get('table_comparitor_comparitor_label_sidebar', table_comparitor_comparitor_label_sidebar),
            ...
            'table.comparitor.rows_query.query.sidebar': extra_params.get('table_comparitor_rows_query_query_sidebar', table_comparitor_rows_query_query_sidebar),
            ...
            'table.comparitor.cols_query.query.sidebar': extra_params.get('table_comparitor_cols_query_query_sidebar', table_comparitor_cols_query_query_sidebar),
