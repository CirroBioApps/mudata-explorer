...
def plotly_line(
    ...
    data_sort_by_table_sidebar=False,
    data_sort_by_cname=None,
    data_sort_by_cname_sidebar=False,
    data_sort_by_label='Sort By',
    data_sort_by_label_sidebar=False,
    ...
    scale_options_title_sidebar=False,
    scale_options_title='',
    **extra_params
):
    """
    ...
    add_view(
        ...
        params={
            ...
            'data.sort_by.table.sidebar': extra_params.get('data_sort_by_table_sidebar', data_sort_by_table_sidebar),
            'data.sort_by.cname': extra_params.get('data_sort_by_cname', data_sort_by_cname),
            'data.sort_by.cname.sidebar': extra_params.get('data_sort_by_cname_sidebar', data_sort_by_cname_sidebar),
            'data.sort_by.label': extra_params.get('data_sort_by_label', data_sort_by_label),
            'data.sort_by.label.sidebar': extra_params.get('data_sort_by_label_sidebar', data_sort_by_label_sidebar),
