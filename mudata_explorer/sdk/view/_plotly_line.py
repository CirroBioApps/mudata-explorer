...
def plotly_line(
    ...
    data_columns_sort_by_sidebar=False,
    data_columns_sort_by_table_value=None,
    data_columns_sort_by_table_sidebar=False,
    data_columns_sort_by_cname_value=None,
    data_columns_sort_by_cname_sidebar=False,
    data_columns_sort_by_label_value='Sort By',
    data_columns_sort_by_label_sidebar=False,
    data_columns_sort_by_scale_value=None,
    data_columns_sort_by_scale_sidebar=False,
    data_columns_sort_by_colorscale=False,
    data_columns_sort_by_is_categorical_value=False,
    data_columns_sort_by_is_categorical_sidebar=False,
    ...
    **extra_params
    ...
    add_view(
        ...
        params={
            ...
            'data.columns.sort_by.sidebar': extra_params.get('data_columns_sort_by_sidebar', data_columns_sort_by_sidebar),
            'data.columns.sort_by.table.value': extra_params.get('data_columns_sort_by_table_value', data_columns_sort_by_table_value),
            'data.columns.sort_by.table.sidebar': extra_params.get('data_columns_sort_by_table_sidebar', data_columns_sort_by_table_sidebar),
            'data.columns.sort_by.cname.value': extra_params.get('data_columns_sort_by_cname_value', data_columns_sort_by_cname_value),
            'data.columns.sort_by.cname.sidebar': extra_params.get('data_columns_sort_by_cname_sidebar', data_columns_sort_by_cname_sidebar),
            'data.columns.sort_by.label.value': extra_params.get('data_columns_sort_by_label_value', data_columns_sort_by_label_value),
            'data.columns.sort_by.label.sidebar': extra_params.get('data_columns_sort_by_label_sidebar', data_columns_sort_by_label_sidebar),
            'data.columns.sort_by.scale.value': extra_params.get('data_columns_sort_by_scale_value', data_columns_sort_by_scale_value),
            'data.columns.sort_by.scale.sidebar': extra_params.get('data_columns_sort_by_scale_sidebar', data_columns_sort_by_scale_sidebar),
            'data.columns.sort_by.colorscale': extra_params.get('data_columns_sort_by_colorscale', data_columns_sort_by_colorscale),
            'data.columns.sort_by.is_categorical.value': extra_params.get('data_columns_sort_by_is_categorical_value', data_columns_sort_by_is_categorical_value),
            'data.columns.sort_by.is_categorical.sidebar': extra_params.get('data_columns_sort_by_is_categorical_sidebar', data_columns_sort_by_is_categorical_sidebar),
