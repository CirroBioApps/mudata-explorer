...
def plotly_scatter_3d(
    ...
    data_columns_z_sidebar=False,
    data_columns_z_table_value=None,
    data_columns_z_table_sidebar=False,
    data_columns_z_cname_value=None,
    data_columns_z_cname_sidebar=False,
    data_columns_z_label_value='z-axis',
    data_columns_z_label_sidebar=False,
    data_columns_z_scale_value=None,
    data_columns_z_scale_sidebar=False,
    data_columns_z_colorscale=False,
    data_columns_z_is_categorical_value=False,
    data_columns_z_is_categorical_sidebar=False,
    ...
    scale_options_log_z_value=None,
    scale_options_log_z_sidebar=True,
    **extra_params
):
    """
    ...
    add_view(
        ...
        params={
            ...
            'data.columns.z.sidebar': extra_params.get('data_columns_z_sidebar', data_columns_z_sidebar),
            'data.columns.z.table.value': extra_params.get('data_columns_z_table_value', data_columns_z_table_value),
            'data.columns.z.table.sidebar': extra_params.get('data_columns_z_table_sidebar', data_columns_z_table_sidebar),
            'data.columns.z.cname.value': extra_params.get('data_columns_z_cname_value', data_columns_z_cname_value),
            'data.columns.z.cname.sidebar': extra_params.get('data_columns_z_cname_sidebar', data_columns_z_cname_sidebar),
            'data.columns.z.label.value': extra_params.get('data_columns_z_label_value', data_columns_z_label_value),
            'data.columns.z.label.sidebar': extra_params.get('data_columns_z_label_sidebar', data_columns_z_label_sidebar),
            'data.columns.z.scale.value': extra_params.get('data_columns_z_scale_value', data_columns_z_scale_value),
            'data.columns.z.scale.sidebar': extra_params.get('data_columns_z_scale_sidebar', data_columns_z_scale_sidebar),
            'data.columns.z.colorscale': extra_params.get('data_columns_z_colorscale', data_columns_z_colorscale),
            'data.columns.z.is_categorical.value': extra_params.get('data_columns_z_is_categorical_value', data_columns_z_is_categorical_value),
            'data.columns.z.is_categorical.sidebar': extra_params.get('data_columns_z_is_categorical_sidebar', data_columns_z_is_categorical_sidebar),
            ...
            'scale_options.log_z.value': extra_params.get('scale_options_log_z_value', scale_options_log_z_value),
