...
class RidgeClassifier(Process):
        ...
        "model_params": {
            ...
            "properties": {
                ...
                "solver": {
                    ...
                    "default": "auto",
                    "label": "Solver",
                    "help": "Solver to use in the computation. 'auto' chooses the best solver for the data.",
    ...
    def execute(self):
        ...
        params = dict(
            ...
            solver=self.params["model_params.solver"],
            positive=self.params["model_params.positive"],
        ...
        # Run the RidgeClassifier
        clf = linear_model.RidgeClassifier(**params)
