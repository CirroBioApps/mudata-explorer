...
class MuDataAppAction:
    ...
    #         value_key = join_kws(prefix_key, "value")
    ...
    #                     self.params[value_key] = self.selectbox(
    #                         label=(
    #                             key
    ...
    #                     self.params[value_key] = self.text_area(
    #                         label=(
    #                             key
    #                             if elem.get("label") is None
    #                             else elem["label"]
    ...
    #                 else:
    #                     self.params[value_key] = self.text_input(
    #                         label=(
    #                             key
    #                             if elem.get("label") is None
    #                             else elem["label"]
    ...
    #             if self.show_param(prefix_key):
    #                 self.params[value_key] = self.number_input(
    ...
    #                     }
    #                 )
    #             if not isinstance(self.params[value_key], (float, int)):
    #                 self.params_complete = False
    ...
    #                     # Update the value
    #                     self.update_view_param(value_key, int(val))
    ...
    #             if self.show_param(prefix_key):
    #                 self.params[value_key] = self.checkbox(
